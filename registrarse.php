	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="includes/registrarse.inc.php" method="POST">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Ingrese su Apellido">
